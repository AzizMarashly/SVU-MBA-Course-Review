...
Bump ../VERSION (vX.Y, the scheme this course started with) and add a row to ../VERSIONS.md first."""
...
assert re.fullmatch(r"\d+\.\d+", ver), "VERSION is vX.Y for MIS (e.g. 1.0), see STATE.md"
