...
Textbooks, slides and exam papers belong to their authors and to the university. They are kept
here only so the reviews can be verified and regenerated by students of the course. Do not
redistribute them separately, and do not add material you are not allowed to share. If you hold
the rights to something in this folder and want it removed, open an issue.
